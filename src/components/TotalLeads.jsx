    ...
    <div className="mt-10 bg-white p-3 rounded-lg">
      <div className="w-full flex justify-between items-center">
        <div>
          ...
          <span className="text-[11px] text-gray-500">
            A summery of your orders
          </span>
        </div>
        <Link to={"/order"}
          className="bg-blue-700 px-4 py-1 rounded-md text-sm text-white"
        >
          VIew All
        </Link>
      </div>
      ...
      <div className="mt-3 border-l-4 border-blue-800 px-2">
        ...
        <p className="text-xs text-gray-500">
          Product Description here this one is really long and it goes over
          maybe?
        </p>
        <span className="text-xs">
          Qualtity: <span className="text-blue-800 font-extrabold">{140}</span>
          pieces
        </span>
      </div>
    </div>
